class selectorPlay1Automation {
    ...
    keyboardTitle(){
        return cy.get('body > div.container.shadow-lg > div:nth-child(7) > div:nth-child(2) > div > div.card-header > h5')
    }

    keyboardDescText(){
        return cy.get(':nth-child(7) > :nth-child(2) > .card > .card-body > .card-text')
    }

    keyboadActionsViewPageButton(){
        return cy.get(':nth-child(7) > :nth-child(2) > .card > .card-body > .btn')
    }
...
export default selectorPlay1Automation