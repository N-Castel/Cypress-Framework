import basePlay1Automation from "../../../pages/8-basePlay1/basePlay1Automation";
...
describe('Play1 Automation test', () => {
    ...
    play1TestFixture.forEach(play1TestFixture => {
        ...
        it('cy Title Playground', () => {
            cy.title().should(play1TestFixture.contain, play1TestFixture.play1GroundTitle)
        })
        ...
        it('Wait conditions Set Min and Max time', () => {
            ...
            basePlay1AutomationPage.minWaitInput().type(3)
            basePlay1AutomationPage.maxWaitInput().clear()
            basePlay1AutomationPage.maxWaitInput().type(6).then(() => {
