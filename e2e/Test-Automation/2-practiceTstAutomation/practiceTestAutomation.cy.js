import baseTestAutomationP from '../../../selector/2-baseTestAutomationPage/selectorTestAutomation.js'
...
describe('Test Automation Practice', () => {
    ...
    beforeEach(() => {
        baseAutomationPage.navigatehome();
    })
    
    dataCredentials.forEach(dataCredentials => {

        it('Complete the form', () => {
            baseAutomationPage.nameField().should('exist');
